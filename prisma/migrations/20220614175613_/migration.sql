...
-- CreateIndex
CREATE UNIQUE INDEX "_reply_AB_unique" ON "_reply"("A", "B");

-- CreateIndex
CREATE INDEX "_reply_B_index" ON "_reply"("B");
...
-- AddForeignKey
ALTER TABLE "_reply" ADD FOREIGN KEY ("A") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_reply" ADD FOREIGN KEY ("B") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
