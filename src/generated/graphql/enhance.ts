...
const modelsInfo = {
  ...
  Tag: ["id", "name", "description", "created_at", "updated_at"],
...
const outputsInfo = {
  ...
  TagGroupBy: ["id", "name", "description", "created_at", "updated_at", "_count", "_min", "_max"],
  ...
  TagCount: ["Post"],
  TagCountAggregate: ["id", "name", "description", "created_at", "updated_at", "_all"],
  TagMinAggregate: ["id", "name", "description", "created_at", "updated_at"],
  TagMaxAggregate: ["id", "name", "description", "created_at", "updated_at"],
  CategoryCount: ["Post"],
...
const inputsInfo = {
  ...
  TagWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "created_at", "updated_at", "Post"],
  TagOrderByWithRelationInput: ["id", "name", "description", "created_at", "updated_at", "Post"],
  TagWhereUniqueInput: ["id", "name"],
  TagOrderByWithAggregationInput: ["id", "name", "description", "created_at", "updated_at", "_count", "_max", "_min"],
  TagScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "description", "created_at", "updated_at"],
  ...
  TagCreateInput: ["id", "name", "description", "created_at", "updated_at", "Post"],
  TagUpdateInput: ["id", "name", "description", "created_at", "updated_at", "Post"],
  TagCreateManyInput: ["id", "name", "description", "created_at", "updated_at"],
  TagUpdateManyMutationInput: ["id", "name", "description", "created_at", "updated_at"],
  ...
  TagCountOrderByAggregateInput: ["id", "name", "description", "created_at", "updated_at"],
  TagMaxOrderByAggregateInput: ["id", "name", "description", "created_at", "updated_at"],
  TagMinOrderByAggregateInput: ["id", "name", "description", "created_at", "updated_at"],
  ...
  TagCreateWithoutPostInput: ["id", "name", "description", "created_at", "updated_at"],
  ...
  TagScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "created_at", "updated_at"],
  ...
  TagUpdateWithoutPostInput: ["id", "name", "description", "created_at", "updated_at"],
