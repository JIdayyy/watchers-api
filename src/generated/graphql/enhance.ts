...
const crudResolversMap = {
  ...
  Forum: crudResolvers.ForumCrudResolver,
  ForumCategory: crudResolvers.ForumCategoryCrudResolver,
...
const actionResolversMap = {
  ...
  Forum: {
    forum: actionResolvers.FindUniqueForumResolver,
    findFirstForum: actionResolvers.FindFirstForumResolver,
    forums: actionResolvers.FindManyForumResolver,
    createForum: actionResolvers.CreateForumResolver,
    createManyForum: actionResolvers.CreateManyForumResolver,
    deleteForum: actionResolvers.DeleteForumResolver,
    updateForum: actionResolvers.UpdateForumResolver,
    deleteManyForum: actionResolvers.DeleteManyForumResolver,
    updateManyForum: actionResolvers.UpdateManyForumResolver,
    upsertForum: actionResolvers.UpsertForumResolver,
    aggregateForum: actionResolvers.AggregateForumResolver,
    groupByForum: actionResolvers.GroupByForumResolver
  },
  ForumCategory: {
    forumCategory: actionResolvers.FindUniqueForumCategoryResolver,
    findFirstForumCategory: actionResolvers.FindFirstForumCategoryResolver,
    forumCategories: actionResolvers.FindManyForumCategoryResolver,
    createForumCategory: actionResolvers.CreateForumCategoryResolver,
    createManyForumCategory: actionResolvers.CreateManyForumCategoryResolver,
    deleteForumCategory: actionResolvers.DeleteForumCategoryResolver,
    updateForumCategory: actionResolvers.UpdateForumCategoryResolver,
    deleteManyForumCategory: actionResolvers.DeleteManyForumCategoryResolver,
    updateManyForumCategory: actionResolvers.UpdateManyForumCategoryResolver,
    upsertForumCategory: actionResolvers.UpsertForumCategoryResolver,
    aggregateForumCategory: actionResolvers.AggregateForumCategoryResolver,
    groupByForumCategory: actionResolvers.GroupByForumCategoryResolver
  },
  Topic: {
  ...
  Article: {
    ...
    createManyArticle: actionResolvers.CreateManyArticleResolver,
    ...
    groupByArticle: actionResolvers.GroupByArticleResolver
  },
  ResetPassword: {
...
const crudResolversInfo = {
  ...
  Forum: ["forum", "findFirstForum", "forums", "createForum", "createManyForum", "deleteForum", "updateForum", "deleteManyForum", "updateManyForum", "upsertForum", "aggregateForum", "groupByForum"],
  ForumCategory: ["forumCategory", "findFirstForumCategory", "forumCategories", "createForumCategory", "createManyForumCategory", "deleteForumCategory", "updateForumCategory", "deleteManyForumCategory", "updateManyForumCategory", "upsertForumCategory", "aggregateForumCategory", "groupByForumCategory"],
  ...
  Article: ["article", "findFirstArticle", "articles", "createArticle", "createManyArticle", "deleteArticle", "updateArticle", "deleteManyArticle", "updateManyArticle", "upsertArticle", "aggregateArticle", "groupByArticle"],
...
const argsInfo = {
  ...
  FindUniqueForumArgs: ["where"],
  FindFirstForumArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyForumArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateForumArgs: ["data"],
  CreateManyForumArgs: ["data", "skipDuplicates"],
  DeleteForumArgs: ["where"],
  UpdateForumArgs: ["data", "where"],
  DeleteManyForumArgs: ["where"],
  UpdateManyForumArgs: ["data", "where"],
  UpsertForumArgs: ["where", "create", "update"],
  AggregateForumArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByForumArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  FindUniqueForumCategoryArgs: ["where"],
  FindFirstForumCategoryArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyForumCategoryArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateForumCategoryArgs: ["data"],
  CreateManyForumCategoryArgs: ["data", "skipDuplicates"],
  DeleteForumCategoryArgs: ["where"],
  UpdateForumCategoryArgs: ["data", "where"],
  DeleteManyForumCategoryArgs: ["where"],
  UpdateManyForumCategoryArgs: ["data", "where"],
  UpsertForumCategoryArgs: ["where", "create", "update"],
  AggregateForumCategoryArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByForumCategoryArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  ...
  FindUniqueArticleArgs: ["where"],
  FindFirstArticleArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyArticleArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateArticleArgs: ["data"],
  CreateManyArticleArgs: ["data", "skipDuplicates"],
  DeleteArticleArgs: ["where"],
  UpdateArticleArgs: ["data", "where"],
  DeleteManyArticleArgs: ["where"],
  UpdateManyArticleArgs: ["data", "where"],
  UpsertArticleArgs: ["where", "create", "update"],
  AggregateArticleArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByArticleArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const relationResolversMap = {
  ...
  Forum: relationResolvers.ForumRelationsResolver,
  ForumCategory: relationResolvers.ForumCategoryRelationsResolver,
  Topic: relationResolvers.TopicRelationsResolver,
  Article: relationResolvers.ArticleRelationsResolver
};
const relationResolversInfo = {
  Account: ["user"],
  Session: ["user"],
  User: ["Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  Preference: ["User"],
  ...
  ForumCategory: ["forum", "topics"],
  Topic: ["forum_category", "articles", "moderators"],
...
const modelsInfo = {
  ...
  Forum: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumCategory: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  Topic: ["id", "name", "created_at", "updated_at", "is_disabled"],
  Article: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ResetPassword: ["id"]
};
...
const outputsInfo = {
  ...
  AggregateForum: ["_count", "_min", "_max"],
  ForumGroupBy: ["id", "name", "created_at", "updated_at", "roles", "is_disabled", "_count", "_min", "_max"],
  AggregateForumCategory: ["_count", "_min", "_max"],
  ForumCategoryGroupBy: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled", "_count", "_min", "_max"],
  AggregateTopic: ["_count", "_min", "_max"],
  TopicGroupBy: ["id", "name", "created_at", "updated_at", "is_disabled", "_count", "_min", "_max"],
  AggregateArticle: ["_count", "_min", "_max"],
  ArticleGroupBy: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled", "_count", "_min", "_max"],
  ...
  UserCount: ["Account", "Comment", "Post", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  ForumCount: ["forum_categories"],
  ForumCountAggregate: ["id", "name", "created_at", "updated_at", "roles", "is_disabled", "_all"],
  ForumMinAggregate: ["id", "name", "created_at", "updated_at", "is_disabled"],
  ForumMaxAggregate: ["id", "name", "created_at", "updated_at", "is_disabled"],
  ForumCategoryCount: ["topics"],
  ForumCategoryCountAggregate: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled", "_all"],
  ForumCategoryMinAggregate: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCategoryMaxAggregate: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  TopicCount: ["articles", "moderators"],
  TopicCountAggregate: ["id", "name", "created_at", "updated_at", "is_disabled", "_all"],
  TopicMinAggregate: ["id", "name", "created_at", "updated_at", "is_disabled"],
  TopicMaxAggregate: ["id", "name", "created_at", "updated_at", "is_disabled"],
  ArticleCountAggregate: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled", "_all"],
  ArticleMinAggregate: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ArticleMaxAggregate: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserOrderByWithRelationInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostWhereInput: ["AND", "OR", "NOT", "id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "userId", "categoryId", "Category", "author", "Comment", "Tags", "User_likes"],
  PostOrderByWithRelationInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "userId", "categoryId", "Category", "author", "Comment", "Tags", "User_likes"],
  ...
  ForumWhereInput: ["AND", "OR", "NOT", "id", "name", "created_at", "updated_at", "forum_categories", "roles", "is_disabled"],
  ForumOrderByWithRelationInput: ["id", "name", "created_at", "updated_at", "forum_categories", "roles", "is_disabled"],
  ForumWhereUniqueInput: ["id"],
  ForumOrderByWithAggregationInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled", "_count", "_max", "_min"],
  ForumScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumCategoryWhereInput: ["AND", "OR", "NOT", "id", "icon", "name", "description", "created_at", "updated_at", "forum", "forum_id", "topics", "is_disabled"],
  ForumCategoryOrderByWithRelationInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum", "forum_id", "topics", "is_disabled"],
  ForumCategoryWhereUniqueInput: ["id"],
  ForumCategoryOrderByWithAggregationInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled", "_count", "_max", "_min"],
  ForumCategoryScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  TopicWhereInput: ["AND", "OR", "NOT", "id", "name", "created_at", "updated_at", "forum_category", "articles", "is_disabled", "moderators"],
  TopicOrderByWithRelationInput: ["id", "name", "created_at", "updated_at", "forum_category", "articles", "is_disabled", "moderators"],
  TopicWhereUniqueInput: ["id"],
  TopicOrderByWithAggregationInput: ["id", "name", "created_at", "updated_at", "is_disabled", "_count", "_max", "_min"],
  TopicScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "created_at", "updated_at", "is_disabled"],
  ArticleWhereInput: ["AND", "OR", "NOT", "id", "name", "content", "created_at", "updated_at", "topic", "author", "author_id", "is_disabled"],
  ArticleOrderByWithRelationInput: ["id", "name", "content", "created_at", "updated_at", "topic", "author", "author_id", "is_disabled"],
  ArticleWhereUniqueInput: ["id"],
  ArticleOrderByWithAggregationInput: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled", "_count", "_max", "_min"],
  ArticleScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ...
  UserCreateInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserUpdateInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostCreateInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "Tags", "User_likes"],
  PostUpdateInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "Tags", "User_likes"],
  ...
  ForumCreateInput: ["id", "name", "created_at", "updated_at", "forum_categories", "roles", "is_disabled"],
  ForumUpdateInput: ["id", "name", "created_at", "updated_at", "forum_categories", "roles", "is_disabled"],
  ForumCreateManyInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumUpdateManyMutationInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumCategoryCreateInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum", "topics", "is_disabled"],
  ForumCategoryUpdateInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum", "topics", "is_disabled"],
  ForumCategoryCreateManyInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCategoryUpdateManyMutationInput: ["id", "icon", "name", "description", "created_at", "updated_at", "is_disabled"],
  TopicCreateInput: ["name", "created_at", "updated_at", "forum_category", "articles", "is_disabled", "moderators"],
  TopicUpdateInput: ["name", "created_at", "updated_at", "forum_category", "articles", "is_disabled", "moderators"],
  TopicCreateManyInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  TopicUpdateManyMutationInput: ["name", "created_at", "updated_at", "is_disabled"],
  ArticleCreateInput: ["name", "content", "created_at", "updated_at", "topic", "author", "is_disabled"],
  ArticleUpdateInput: ["name", "content", "created_at", "updated_at", "topic", "author", "is_disabled"],
  ArticleCreateManyInput: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ArticleUpdateManyMutationInput: ["name", "content", "created_at", "updated_at", "is_disabled"],
  ...
  ArticleListRelationFilter: ["every", "some", "none"],
  ...
  ArticleOrderByRelationAggregateInput: ["_count"],
  ...
  ForumCategoryListRelationFilter: ["every", "some", "none"],
  EnumRoleNullableListFilter: ["equals", "has", "hasEvery", "hasSome", "isEmpty"],
  ForumCategoryOrderByRelationAggregateInput: ["_count"],
  ForumCountOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumMaxOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  ForumMinOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  ForumRelationFilter: ["is", "isNot"],
  ForumCategoryCountOrderByAggregateInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCategoryMaxOrderByAggregateInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCategoryMinOrderByAggregateInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCategoryRelationFilter: ["is", "isNot"],
  TopicCountOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  TopicMaxOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  TopicMinOrderByAggregateInput: ["id", "name", "created_at", "updated_at", "is_disabled"],
  TopicRelationFilter: ["is", "isNot"],
  ArticleCountOrderByAggregateInput: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ArticleMaxOrderByAggregateInput: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ArticleMinOrderByAggregateInput: ["id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ...
  ArticleCreateNestedManyWithoutAuthorInput: ["create", "connectOrCreate", "createMany", "connect"],
  TopicCreateNestedManyWithoutModeratorsInput: ["create", "connectOrCreate", "connect"],
  ...
  ArticleUpdateManyWithoutAuthorInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  TopicUpdateManyWithoutModeratorsInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ForumCategoryCreateNestedManyWithoutForumInput: ["create", "connectOrCreate", "createMany", "connect"],
  ForumCreaterolesInput: ["set"],
  ForumCategoryUpdateManyWithoutForumInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ForumUpdaterolesInput: ["set", "push"],
  ForumCreateNestedOneWithoutForum_categoriesInput: ["create", "connectOrCreate", "connect"],
  TopicCreateNestedManyWithoutForum_categoryInput: ["create", "connectOrCreate", "createMany", "connect"],
  ForumUpdateOneRequiredWithoutForum_categoriesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  TopicUpdateManyWithoutForum_categoryInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ForumCategoryCreateNestedOneWithoutTopicsInput: ["create", "connectOrCreate", "connect"],
  ArticleCreateNestedManyWithoutTopicInput: ["create", "connectOrCreate", "createMany", "connect"],
  UserCreateNestedManyWithoutTopics_moderatedInput: ["create", "connectOrCreate", "connect"],
  ForumCategoryUpdateOneRequiredWithoutTopicsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ArticleUpdateManyWithoutTopicInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  UserUpdateManyWithoutTopics_moderatedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  TopicCreateNestedOneWithoutArticlesInput: ["create", "connectOrCreate", "connect"],
  UserCreateNestedOneWithoutForum_articlesInput: ["create", "connectOrCreate", "connect"],
  TopicUpdateOneRequiredWithoutArticlesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  UserUpdateOneRequiredWithoutForum_articlesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateWithoutAccountInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutAccountInput: ["where", "create"],
  UserUpsertWithoutAccountInput: ["update", "create"],
  UserUpdateWithoutAccountInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateWithoutSessionInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutSessionInput: ["where", "create"],
  UserUpsertWithoutSessionInput: ["update", "create"],
  UserUpdateWithoutSessionInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostCreateWithoutAuthorInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "Comment", "Tags", "User_likes"],
  ...
  UserCreateWithoutUser_AInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutUser_AInput: ["where", "create"],
  UserCreateWithoutUser_BInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutUser_BInput: ["where", "create"],
  PostCreateWithoutUser_likesInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "Tags"],
  PostCreateOrConnectWithoutUser_likesInput: ["where", "create"],
  ArticleCreateWithoutAuthorInput: ["name", "content", "created_at", "updated_at", "topic", "is_disabled"],
  ArticleCreateOrConnectWithoutAuthorInput: ["where", "create"],
  ArticleCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  TopicCreateWithoutModeratorsInput: ["name", "created_at", "updated_at", "forum_category", "articles", "is_disabled"],
  TopicCreateOrConnectWithoutModeratorsInput: ["where", "create"],
  ...
  ArticleUpsertWithWhereUniqueWithoutAuthorInput: ["where", "update", "create"],
  ArticleUpdateWithWhereUniqueWithoutAuthorInput: ["where", "data"],
  ArticleUpdateManyWithWhereWithoutAuthorInput: ["where", "data"],
  ArticleScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  TopicUpsertWithWhereUniqueWithoutModeratorsInput: ["where", "update", "create"],
  TopicUpdateWithWhereUniqueWithoutModeratorsInput: ["where", "data"],
  TopicUpdateManyWithWhereWithoutModeratorsInput: ["where", "data"],
  TopicScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "created_at", "updated_at", "is_disabled"],
  UserCreateWithoutPreferenceInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutPreferenceInput: ["where", "create"],
  UserUpsertWithoutPreferenceInput: ["update", "create"],
  UserUpdateWithoutPreferenceInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  CategoryCreateWithoutPostInput: ["id", "name", "created_at", "updated_at"],
  CategoryCreateOrConnectWithoutPostInput: ["where", "create"],
  UserCreateWithoutPostInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  UserCreateWithoutPost_likesInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "forum_articles", "topics_moderated"],
  ...
  UserUpdateWithoutPostInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostCreateWithoutCommentInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Tags", "User_likes"],
  PostCreateOrConnectWithoutCommentInput: ["where", "create"],
  UserCreateWithoutCommentInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostUpdateWithoutCommentInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Tags", "User_likes"],
  UserUpsertWithoutCommentInput: ["update", "create"],
  UserUpdateWithoutCommentInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  PostCreateWithoutTagsInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "User_likes"],
  ...
  PostCreateWithoutCategoryInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "author", "Comment", "Tags", "User_likes"],
  ...
  ForumCategoryCreateWithoutForumInput: ["id", "icon", "name", "description", "created_at", "updated_at", "topics", "is_disabled"],
  ForumCategoryCreateOrConnectWithoutForumInput: ["where", "create"],
  ForumCategoryCreateManyForumInputEnvelope: ["data", "skipDuplicates"],
  ForumCategoryUpsertWithWhereUniqueWithoutForumInput: ["where", "update", "create"],
  ForumCategoryUpdateWithWhereUniqueWithoutForumInput: ["where", "data"],
  ForumCategoryUpdateManyWithWhereWithoutForumInput: ["where", "data"],
  ForumCategoryScalarWhereInput: ["AND", "OR", "NOT", "id", "icon", "name", "description", "created_at", "updated_at", "forum_id", "is_disabled"],
  ForumCreateWithoutForum_categoriesInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  ForumCreateOrConnectWithoutForum_categoriesInput: ["where", "create"],
  TopicCreateWithoutForum_categoryInput: ["name", "created_at", "updated_at", "articles", "is_disabled", "moderators"],
  TopicCreateOrConnectWithoutForum_categoryInput: ["where", "create"],
  TopicCreateManyForum_categoryInputEnvelope: ["data", "skipDuplicates"],
  ForumUpsertWithoutForum_categoriesInput: ["update", "create"],
  ForumUpdateWithoutForum_categoriesInput: ["id", "name", "created_at", "updated_at", "roles", "is_disabled"],
  TopicUpsertWithWhereUniqueWithoutForum_categoryInput: ["where", "update", "create"],
  TopicUpdateWithWhereUniqueWithoutForum_categoryInput: ["where", "data"],
  TopicUpdateManyWithWhereWithoutForum_categoryInput: ["where", "data"],
  ForumCategoryCreateWithoutTopicsInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum", "is_disabled"],
  ForumCategoryCreateOrConnectWithoutTopicsInput: ["where", "create"],
  ArticleCreateWithoutTopicInput: ["name", "content", "created_at", "updated_at", "author", "is_disabled"],
  ArticleCreateOrConnectWithoutTopicInput: ["where", "create"],
  ArticleCreateManyTopicInputEnvelope: ["data", "skipDuplicates"],
  UserCreateWithoutTopics_moderatedInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles"],
  UserCreateOrConnectWithoutTopics_moderatedInput: ["where", "create"],
  ForumCategoryUpsertWithoutTopicsInput: ["update", "create"],
  ForumCategoryUpdateWithoutTopicsInput: ["id", "icon", "name", "description", "created_at", "updated_at", "forum", "is_disabled"],
  ArticleUpsertWithWhereUniqueWithoutTopicInput: ["where", "update", "create"],
  ArticleUpdateWithWhereUniqueWithoutTopicInput: ["where", "data"],
  ArticleUpdateManyWithWhereWithoutTopicInput: ["where", "data"],
  UserUpsertWithWhereUniqueWithoutTopics_moderatedInput: ["where", "update", "create"],
  UserUpdateWithWhereUniqueWithoutTopics_moderatedInput: ["where", "data"],
  UserUpdateManyWithWhereWithoutTopics_moderatedInput: ["where", "data"],
  TopicCreateWithoutArticlesInput: ["name", "created_at", "updated_at", "forum_category", "is_disabled", "moderators"],
  TopicCreateOrConnectWithoutArticlesInput: ["where", "create"],
  UserCreateWithoutForum_articlesInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "topics_moderated"],
  UserCreateOrConnectWithoutForum_articlesInput: ["where", "create"],
  TopicUpsertWithoutArticlesInput: ["update", "create"],
  TopicUpdateWithoutArticlesInput: ["name", "created_at", "updated_at", "forum_category", "is_disabled", "moderators"],
  UserUpsertWithoutForum_articlesInput: ["update", "create"],
  UserUpdateWithoutForum_articlesInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "topics_moderated"],
  UserCreateWithoutResetPasswordInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  UserCreateOrConnectWithoutResetPasswordInput: ["where", "create"],
  UserUpsertWithoutResetPasswordInput: ["update", "create"],
  UserUpdateWithoutResetPasswordInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "Session", "User_B", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  ...
  ArticleCreateManyAuthorInput: ["id", "name", "content", "created_at", "updated_at", "is_disabled"],
  ...
  PostUpdateWithoutAuthorInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "Comment", "Tags", "User_likes"],
  ResetPasswordUpdateWithoutUserInput: ["id", "token", "created_at", "updated_at"],
  SessionUpdateWithoutUserInput: ["id", "sessionToken", "expires"],
  UserUpdateWithoutUser_AInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "Post_likes", "forum_articles", "topics_moderated"],
  UserUpdateWithoutUser_BInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_A", "Post_likes", "forum_articles", "topics_moderated"],
  PostUpdateWithoutUser_likesInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "Tags"],
  ArticleUpdateWithoutAuthorInput: ["name", "content", "created_at", "updated_at", "topic", "is_disabled"],
  TopicUpdateWithoutModeratorsInput: ["name", "created_at", "updated_at", "forum_category", "articles", "is_disabled"],
  ...
  UserUpdateWithoutPost_likesInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "forum_articles", "topics_moderated"],
  ...
  PostUpdateWithoutTagsInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "Category", "author", "Comment", "User_likes"],
  PostCreateManyCategoryInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "userId"],
  PostUpdateWithoutCategoryInput: ["id", "slug", "title", "cover_picture", "content", "isDraft", "created_at", "updated_at", "author", "Comment", "Tags", "User_likes"],
  ForumCategoryCreateManyForumInput: ["id", "icon", "name", "description", "created_at", "updated_at", "is_disabled"],
  ForumCategoryUpdateWithoutForumInput: ["id", "icon", "name", "description", "created_at", "updated_at", "topics", "is_disabled"],
  TopicCreateManyForum_categoryInput: ["name", "created_at", "updated_at", "is_disabled"],
  TopicUpdateWithoutForum_categoryInput: ["name", "created_at", "updated_at", "articles", "is_disabled", "moderators"],
  ArticleCreateManyTopicInput: ["name", "content", "created_at", "updated_at", "author_id", "is_disabled"],
  ArticleUpdateWithoutTopicInput: ["name", "content", "created_at", "updated_at", "author", "is_disabled"],
  UserUpdateWithoutTopics_moderatedInput: ["id", "first_name", "last_name", "email", "image", "emailVerified", "name", "password", "is_disabled", "avatar", "role", "created_at", "updated_at", "nickname", "follower_id", "Account", "Comment", "Post", "Preference", "ResetPassword", "Session", "User_B", "User_A", "Post_likes", "forum_articles"]
};
