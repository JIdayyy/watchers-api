...
export class LikeCrudResolver {
  ...
  async createLike(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateLikeArgs): Promise<Like> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteLike(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteLikeArgs): Promise<Like | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateLike(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateLikeArgs): Promise<Like | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertLike(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertLikeArgs): Promise<Like> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
